...
function Menu() {
  ...
  const {filterby}= useParams() //this will have the id of the product we click on
    ...
    <div className='p-2 md:p-4'>
      <div className='w-full max-w-4xl m-auto md:flex bg-white'>
        <div className='max-w-sm overflow-hidden w-full p-5'>
          <img src={productDisplay.image} alt='prodctImage' className='hover:scale-105 transition-all h-full' />
        </div>
